      ...
      <div className="w-full max-w-[420px]">
        ...
        <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500">Start monitoring your repositories for free.</p>
          </div>
          ...
          <p className="mt-6 text-xs text-center text-slate-500 leading-relaxed">
            ...
            <Link href="/terms-of-service" className="text-blue-600 hover:text-blue-700 hover:underline">Terms of Service</Link> and <Link href="/privacy-policy" className="text-blue-600 hover:text-blue-700 hover:underline">Privacy Policy</Link>.
          </p>
        </div>

        <div className="text-center text-sm font-medium text-slate-600">
          Already have an account? <Link href="/auth/login" className="text-blue-600 font-bold hover:text-blue-700">Log in</Link>
        </div>
      </div>
    </div>
  );
